        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    {{-- Add Button --}}
                    <button type="button" id="btnAddCustomer" class="inline-flex items-center px-5 py-2 bg-secondary text-white rounded-lg hover:bg-[#4a0f75] transition-colors text-[13px] font-medium">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($customers as $customer)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700">{{ $customer->created_at->format('d/m/Y') }}</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form action="{{ route('kasir.customer.destroy', $customer->id) }}" method="POST" class="inline delete-form">
                                            @csrf
                                            @method('DELETE')
...
{{-- Add Modal --}}
<div id="modalAdd" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md transform transition-all">
            <div class="p-6">
                ...
                <form id="formAdd" action="{{ route('kasir.customer.store') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="add_name" class="block text-sm font-medium text-gray-700 mb-1">Nama <span class="text-red-500">*</span></label>
...
{{-- Edit Modal --}}
<div id="modalEdit" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md transform transition-all">
            <div class="p-6">
                <div class="flex items-center justify-between mb-4">
                ...
                <form id="formEdit" method="POST">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="edit_name" class="block text-sm font-medium text-gray-700 mb-1">Nama <span class="text-red-500">*</span></label>
