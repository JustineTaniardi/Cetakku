...
<body class="antialiased overflow-hidden">
    ...
    <div class="fixed inset-0 -z-10">
        <img src="{{ asset('images/login_bg.jpg') }}" class="w-full h-full object-cover" loading="eager"
            decoding="async" />
    ...
    <div class="h-screen flex flex-col lg:flex-row">
        ...
        <div class="hidden lg:flex lg:w-3/5 relative">
            <div class="absolute bottom-16 left-16 max-w-3xl z-10">
                <h1 class="font-inter text-white text-5xl font-bold leading-tight mb-6">
        ...
        <div class="w-full lg:w-[45%] flex items-center justify-center p-6 md:p-10 lg:p-12">
            <div
                ...
                <h2 class="text-2xl md:text-3xl font-bold mt-16 mb-2">
                    Masukkan Akun.
                </h2>

                <p class="text-sm md:text-base text-gray-600">
                    Akses cepat ke sistem digital printing perusahaan.
                </p>
    ...
    <!-- Email -->
    <div>
        <label class="block text-xs md:text-sm font-medium text-gray-700 mb-2" for="email">
            Email
        </label>
    ...
    <!-- Password -->
    <div>
        <label class="block text-xs md:text-sm font-medium text-gray-700 mb-2" for="password">
            Password
        </label>
    ...
    <!-- Login Button -->
    <button type="submit"
        class="w-full bg-purple-950 hover:bg-purple-800 text-white font-semibold md:py-3.5 py-3 text-sm md:text-base rounded-lg transition duration-200 mt-4">
        Masuk
    </button>
</form>
