    ...
    <nav class="space-y-4 text-sm overflow-y-auto flex-1">
        ...
        <div>
            ...
            <a href="{{ route('kasir.dashboard') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.dashboard') ? 'dasbor_selected.png' : 'dasbor.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.order') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.order') ? 'pesanan_selected.png' : 'pesanan.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.customer') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.customer') ? 'pembeli_selected.png' : 'pembeli.png')) }}"
                    class="w-3.5 h-3.5">
        ...
        <div>
            ...
            <a href="{{ route('kasir.product') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.product') ? 'produk_selected.png' : 'produk.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.category') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.category') ? 'kategori_selected.png' : 'kategori.png')) }}"
                    class="w-3.5 h-3.5">
                <span class="text-[13px]">Kategori & Satuan</span>
            </a>
        </div>
        ...
        <div>
            ...
            <a href="{{ route('kasir.job') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.job') ? 'pekerjaan_selected.png' : 'pekerjaan.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.invoice') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.invoice') ? 'faktur_selected.png' : 'faktur.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.payment') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.payment') ? 'pembayaran_selected.png' : 'pembayaran.png')) }}"
                    class="w-3.5 h-3.5">
        ...
        <div>
            ...
            <a href="{{ route('kasir.supplier') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.supplier') ? 'pemasok_selected.png' : 'pemasok.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.material') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.material') ? 'bahan_selected.png' : 'bahan.png')) }}"
                    class="w-3.5 h-3.5">
        ...
        <div>
            ...
            <a href="{{ route('kasir.receivable') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.receivable') ? 'piutang_selected.png' : 'piutang.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.debt') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.debt') ? 'hutang_selected.png' : 'hutang.png')) }}"
                    class="w-3.5 h-3.5">
            ...
            <a href="{{ route('kasir.omset') }}"
                ...
                <img src="{{ asset('assets/icons/' . (request()->routeIs('kasir.omset') ? 'omset_selected.png' : 'omset.png')) }}"
                    class="w-3.5 h-3.5">
