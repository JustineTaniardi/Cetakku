...
Route::middleware(['auth', 'role:kasir'])->prefix('kasir')->name('kasir.')->group(function () {
    ...
    // Material Suppliers (AJAX)
    Route::get('/material/{id}/suppliers', [MaterialController::class, 'getSuppliersByMaterial'])->name('material.suppliers');
    Route::get('/material/by-product/{id}', [MaterialController::class, 'getMaterialsByProduct'])->name('material.by-product');
    Route::post('/material/purchase', [MaterialController::class, 'purchaseMaterial'])->name('material.purchase');
